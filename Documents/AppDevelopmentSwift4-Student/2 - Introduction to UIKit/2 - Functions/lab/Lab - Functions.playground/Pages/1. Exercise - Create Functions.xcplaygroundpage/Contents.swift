...
func introduceMyself(to Person: String, lastName: String) {
    print("Hi my name is \(Person) + \(lastName).")
}

introduceMyself(to: "Dallin", lastName: "Smuin")
